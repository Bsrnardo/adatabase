...
| nom_article       | nom de l'article        | Texte     |      |                   |                                  |
...
| quantite          | quantite                | Integer   |      | FK, en attente    |                                  |
...
| nb_places         | nmero de places         | Numerique |      | Obligatoire       |                                  |
...
| id_benevole       | id du benevole          | Serial    |      |                   |                                  |
...
| id_atelier        | id de l'atelier         | Integer   |      | Obligatoire       |                                  |
